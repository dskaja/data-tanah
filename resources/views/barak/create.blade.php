...
@section('title', 'Tambah Data Barak')

@section('content')
<div class="content-body">
    <div class="form-container">
        <form action="{{ route('barak.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <small class="text-muted">
                                <i class="fas fa-info-circle"></i> Pilih tanah tempat barak ini berada (termasuk tanah Polres)
                            </small>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" id="nama" 
                                   ...
                                   value="{{ old('nama') }}" placeholder="Contoh: Barak Utama" required>
                            @error('nama')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="alamat" id="alamat" rows="3" 
                                      ...
                                      placeholder="Masukkan alamat lengkap barak" required>{{ old('alamat') }}</textarea>
                            @error('alamat')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
