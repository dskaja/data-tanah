...
@section('title', 'Edit Data Barak')

@section('content')
<div class="content-body">
    <div class="form-container">
        <form action="{{ route('barak.update', $barak->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')

            <div class="form-section">
                <div class="section-title">
                    <i class="fas fa-warehouse"></i> Informasi Barak
                </div>
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="tanah_id" id="tanah_id" 
                                ...
                                @foreach($tanahList as $tanah)
                                    <option value="{{ $tanah->id }}" {{ old('tanah_id', $barak->tanah_id) == $tanah->id ? 'selected' : '' }}>
                            ...
                            <small class="text-muted">
                                <i class="fas fa-info-circle"></i> Pilih tanah tempat barak ini berada
                            </small>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="nama">Nama Barak <span class="required">*</span></label>
                            <input type="text" name="nama" id="nama" 
                                   class="form-control @error('nama') is-invalid @enderror" 
                                   value="{{ old('nama', $barak->nama) }}" required>
                            @error('nama')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="luas_bangunan" id="luas_bangunan" 
                                   ...
                                   value="{{ old('luas_bangunan', $barak->luas_bangunan) }}" required>
                            @error('luas_bangunan')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="bangunan_di_atas" id="bangunan_di_atas" 
                                   ...
                                   value="{{ old('bangunan_di_atas', $barak->bangunan_di_atas) }}" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="alamat" id="alamat" rows="3" 
                                      ...
                                      required>{{ old('alamat', $barak->alamat) }}</textarea>
                            @error('alamat')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="foto">Foto Barak</label>
                            @if($barak->foto)
                                <div class="foto-preview">
                                   <img src="{{ config('filesystem_path.url.barak').'/'.$barak->foto }}">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="keterangan" id="keterangan" rows="3" 
                                      ...
                                      placeholder="Keterangan tambahan (opsional)">{{ old('keterangan', $barak->keterangan) }}</textarea>
                            @error('keterangan')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <div class="form-actions">
                ...
                <a href="{{ route('barak.index') }}" class="btn-cancel">
