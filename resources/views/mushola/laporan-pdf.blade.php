...
<head>
    <meta charset="UTF-8">
    <title>Laporan Data Mushola</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <table class="summary-table">
        <tr>
            <td class="summary-label">Total Mushola</td>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 150px;">Nama Mushola</th>
        ...
        <tbody>
            ...
            @empty
            <tr>
                <td colspan="6" class="text-center">Tidak ada data mushola</td>
            </tr>
            @endforelse
        </tbody>
    </table>
    ...
    <div class="footer-text">
        Dokumen ini dicetak secara otomatis dari Sistem Pengelolaan Data Mushola<br>
