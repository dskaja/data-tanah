            ...
            <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                <div>
                    <div class="table-title">
                        <i class="fas fa-mosque"></i> Data Mushola
                    </div>
                ...
                <div style="display: flex; gap: 10px;">
                    ...
                    <a href="{{ route('mushola.laporan-pdf') }}" target="_blank" class="btn-report">
                        <i class="fas fa-file-pdf"></i> Cetak Laporan
                    </a>
                    <a href="{{ route('mushola.create') }}" class="btn-add">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="action-buttons">
                                <a href="{{ route('mushola.show', $item->id) }}" class="btn-action btn-info" title="Detail">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('mushola.edit', $item->id) }}" class="btn-action btn-warning" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('mushola.destroy', $item->id) }}" method="POST" style="display: inline;" 
                    ...
                    <tr class="empty-row">
                        <td colspan="7" class="text-center" style="padding: 50px;">
                            ...
                            <p style="color: #999; font-size: 15px;">Belum ada data mushola</p>
                            <a href="{{ route('mushola.create') }}" class="btn-add" style="margin-top: 15px; display: inline-flex;">
