...
@section('title', 'Edit Data Kantor Polsek')
        ...
        <form action="{{ route('kantor.update', $kantor->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-section">
                <div class="section-title">
                    <i class="fas fa-building"></i> Informasi Kantor Polsek
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <small class="text-muted">
                                <i class="fas fa-info-circle"></i> Pilih tanah tempat kantor polsek ini berada
                            </small>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="polsek_nama" id="polsek_nama" 
                                   ...
                                   value="{{ old('polsek_nama', $kantor->polsek_nama) }}" required>
                            @error('polsek_nama')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
