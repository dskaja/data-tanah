...
@section('title', 'Tambah Data Garasi')
        ...
        <form action="{{ route('garasi.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-section">
                <div class="section-title">
                    <i class="fas fa-warehouse"></i> Informasi Garasi
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <small class="text-muted">
                                <i class="fas fa-info-circle"></i> Pilih tanah tempat garasi ini berada (termasuk tanah Polres)
                            </small>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" id="nama" 
                                   ...
                                   value="{{ old('nama') }}" placeholder="Contoh: Garasi Utama" required>
                            @error('nama')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="alamat" id="alamat" rows="3" 
                                      ...
                                      placeholder="Masukkan alamat lengkap garasi" required>{{ old('alamat') }}</textarea>
                            @error('alamat')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
