...
<div class="content-body">
    <div class="form-container">
        <form action="{{ route('tanah.update', $tanah->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <input type="hidden" name="kategori" value="{{ $tanah->kategori }}">
            ...
            <div class="form-section">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="polsek_nama" id="polsek_nama" class="form-control @error('polsek_nama') is-invalid @enderror" required>
                                ...
                                <option value="{{ $polsek }}" {{ (old('polsek_nama', $tanah->polsek_nama) == $polsek) ? 'selected' : '' }}>
                                    {{ $polsek }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <!-- Nama -->
                    <div class="col-md-{{ $tanah->kategori == 'polsek' ? '6' : '12' }}">
                        <div class="form-group">
                            <label for="nama">Nama Tanah <span class="required">*</span></label>
                            <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror" 
                                   value="{{ old('nama', $tanah->nama) }}" placeholder="Contoh: Tanah Kantor Polres" required>
                            @error('nama')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="alamat" id="alamat" rows="3" class="form-control @error('alamat') is-invalid @enderror" 
                                      placeholder="Masukkan alamat lengkap tanah" required>{{ old('alamat', $tanah->alamat) }}</textarea>
                            @error('alamat')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="luas_seluruhnya" id="luas_seluruhnya" 
                                   ...
                                   value="{{ old('luas_seluruhnya', $tanah->luas_seluruhnya) }}" placeholder="0.00" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="luas_tanah_bangunan" id="luas_tanah_bangunan" 
                                   ...
                                   value="{{ old('luas_tanah_bangunan', $tanah->luas_tanah_bangunan) }}" placeholder="0.00" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="luas_tanah_sarana" id="luas_tanah_sarana" 
                                   ...
                                   value="{{ old('luas_tanah_sarana', $tanah->luas_tanah_sarana) }}" placeholder="0.00" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control @error('status') is-invalid @enderror" required>
                                ...
                                <option value="Sertifikat" {{ old('status', $tanah->status) == 'Sertifikat' ? 'selected' : '' }}>Sertifikat</option>
                                <option value="Pinjam pakai" {{ old('status', $tanah->status) == 'Pinjam pakai' ? 'selected' : '' }}>Pinjam Pakai</option>
                            </select>
                            @error('status')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            @if($tanah->foto)
                            <div class="mb-2">
                                <img src="{{ asset(config('filesystem_path.url.tanah') . '/' . $tanah->foto) }}">
                                <p class="text-muted">Foto saat ini (akan diganti jika upload baru)</p>
                            </div>
                            @endif
