...
@section('title', 'Data Tanah Polres')
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                <div>
                    <div class="table-title">
                        <i class="fas fa-list"></i> Daftar Tanah Polres
                    </div>
                ...
                <div style="display: flex; gap: 10px;">
                    ...
                    <a href="{{ route('tanah.polres.create') }}" class="btn-add">
                ...
                <tbody>
                    ...
                    <tr class="empty-row">
                        <td colspan="5" class="text-center" style="padding: 50px;">
                            ...
                            <p style="color: #999; font-size: 15px;">Belum ada data tanah Polres</p>
                            <a href="{{ route('tanah.polres.create') }}" class="btn-add" style="margin-top: 15px; display: inline-flex;">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <select name="status" class="form-control">
                        ...
                        <option value="Girik">Pinjam Pakai</option>
                    </select>
                </div>
            </div>
